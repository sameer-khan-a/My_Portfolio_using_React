    ...
    >
      ...
      <div class="container-fluid home">
        <h1 style={{ color: "white" }}>
          Hello There, <img src="hi.gif" hieght="50" width="100" />
        </h1>
        <h2 class="" style={{ fontSize: "40px" }}>
          <span style={{ color: "white" }}>I'M </span>
          <span style={{ textDecoration: "underline" }}>Sam</span>eer{" "}
          <span style={{ textDecoration: "underline" }}>Kh</span>an A
        </h2>
        <h2
          class="mt-5 aim"
